...
Обеспечить подтверждение указанного пользователем номера телефона. 
Тип проверки смс с кодом, время жизни кода ограничено (3-5 минут).
...
1. Требует уточнения формат хранения тестовых описаний уроков в БД. Судя по макету описание предполагает 
