...
def user(django_user_model):
    return django_user_model.objects.create_user(email="testuser@test.com", password="1234567")


@pytest.fixture
def user_2(django_user_model):
    return django_user_model.objects.create_user(email="testuser2@test.com", password="1234567")
