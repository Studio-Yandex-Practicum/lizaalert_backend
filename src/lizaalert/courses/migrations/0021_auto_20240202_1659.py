# Generated by Django 3.2.23 on 2024-02-02 13:59
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cohort_number', models.PositiveIntegerField(blank=True, help_text='Данное поле будет рассчитано автоматически при сохранении.', verbose_name='Номер группы')),
        ...
        migrations.AddField(
            model_name='cohort',
            name='course',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='cohorts', to='courses.course', verbose_name='Курс'),
        ),
        migrations.AddField(
            model_name='cohort',
            name='teacher',
