...
from lizaalert.courses.views import CourseLessonListViewSet, CourseStatusViewSet, CourseViewSet, FilterListView
...
urlpatterns = [
    ...
    path("filters/", FilterListView.as_view(), name="filters-list"),
]
