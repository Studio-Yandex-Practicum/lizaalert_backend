    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('userchapterprogress', models.CharField(choices=[('Finished', 'Пройден')], max_length=20, verbose_name='прогресс главы')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('usercourseprogress', models.CharField(choices=[('Finished', 'Пройден')], max_length=20, verbose_name='прогресс курса')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('userlessonprogress', models.CharField(choices=[('Finished', 'Пройден')], max_length=20, verbose_name='прогресс урока')),
