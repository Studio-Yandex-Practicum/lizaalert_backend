...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(choices=[('Новичок', 'Новичок'), ('Бывалый', 'Бывалый'), ('Профессионал', 'Профессионал')], max_length=20, verbose_name='Наименование уровня')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.CharField(choices=[('Активный', 'Activ'), ('Пройден', 'Complete'), ('Вы записаны', 'Registration')], max_length=20, verbose_name='Статус курса')),
        ...
        migrations.AddField(
            ...
            name='badges',
            field=models.ManyToManyField(blank=True, related_name='volunteers', through='users.VolunteerBadge', to='users.Badge', verbose_name='Значки'),
        ),
        migrations.AddField(
            model_name='volunteer',
            name='courses',
        ...
        migrations.AddField(
            model_name='volunteer',
            name='level',
            field=models.ManyToManyField(blank=True, related_name='volunteers', through='users.VolunteerLevel', to='users.Level', verbose_name='Уровень'),
        ),
        migrations.AddField(
            model_name='volunteer',
            name='location',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='volunteers', to='users.location', verbose_name='Географический регион'),
        ),
        migrations.AddField(
            model_name='volunteer',
            name='user',
